function _0x2ba2() {
      const _0x3e0e74 = [
        ...
        "APPDATA",
        "nationsgui.dat",
        "https://authserver.nationsglory.fr/v2/reauth?lang=",
        ...
        "includes",
        "binaries",
        "Téléchargement\x20du\x20fichier:\x20",
        "bin",
        "invoke",
        ...
        "onmouseenter",
        "access",
        "https://apiv2.nationsglory.fr/launcher/home?lang=",
        ...
        "toString",
        "remoteJSONPath",
        "https://apiv2.nationsglory.fr/launcher/getMoreMods?token=",
        "send",
        "NGRadioDuration",
        "localFilesBasePath",
        "parse",
...
function handleStoreChange(_0x161858, _0x27e4f3) {
  ...
  switch (_0x161858) {
    case "username":
      ((username = _0x27e4f3), updateAvatar(username));
      break;
...
(ipcRenderer["on"](
  _0x9ab494(0x113),
  async (_0x5baea1, _0x118c40, _0x5a4b68) => {
  ...
  document[_0x9ab494(0x164)](_0x9ab494(0x179), function () {
    ...
    (_0x5c900f && updateAvatar(_0x5c900f),
...
ipcRenderer["on"](_0x9ab494(0x156), async (_0x2656ef, _0x18424c, _0x5d72ab) => {
  ...
  (_0x18424c == _0x54f2da(0x118) && (version = _0x5d72ab),
    _0x18424c == _0x54f2da(0x124) &&
      ((playing = ipcRenderer["sendSync"](_0x54f2da(0x126), _0x54f2da(0x124))),
      setPlayButtonState(_0x5d72ab)),
    _0x18424c == "TriggerNGRadio" &&
      (setPlayButtonState(_0x5d72ab),
...
const hddid = hddidUser,
  startTimestamp = new Date(),
  min_ram = 0x1;
window[_0x9ab494(0xd4)] = async function () {
  const _0xd7c3cb = _0x9ab494;
  ((version = await ipcRenderer[_0xd7c3cb(0x16f)](
    _0xd7c3cb(0x126),
    "currentVersion",
  )),
    console[_0xd7c3cb(0x236)](_0xd7c3cb(0x1d2), version),
    ipcRenderer["send"](_0xd7c3cb(0xe3), {
      state: _0xd7c3cb(0x21f),
      details: _0xd7c3cb(0x1d5),
      startTimestamp: startTimestamp,
      largeImageKey: "thumbnail",
      largeImageText: _0xd7c3cb(0x1e8),
      smallImageKey: _0xd7c3cb(0x143),
      smallImageText: username,
      instance: ![],
      buttons: [{ label: _0xd7c3cb(0x1b8), url: _0xd7c3cb(0x1c1) }],
    }));
  ...
  function _0x22af52(_0x20ad1a, _0x18d651, _0x2c96e1 = 0x12c) {
    ...
    !_0x20ad1a[_0x2e7928(0x157)](_0x18d651) &&
      (_0x2c1058 = setTimeout(() => {
        const _0x4bcf30 = _0x2e7928;
        _0x431dfd[_0x4bcf30(0x18b)][_0x4bcf30(0x17d)] = _0x4bcf30(0x12f);
      }, _0x2c96e1));
  }
  getInfo();
};
...
function getInfo() {
  ...
  instance[_0xf66243(0x20d)](API_RADIO)[_0xf66243(0x13c)]((_0x47bf92) => {
    ...
    try {
      const data = _0x47bf92?.[_0xd9f79e(0x185)]?.[_0xd9f79e(0xf2)];

      // 🔴 STOP si pas de data ou pas de song
      if (!data || !data.song) return;

      const song = data.song;

      // --- IMAGE PRINCIPALE ---
      const img = document.getElementById(_0xd9f79e(0x108));
      if (img) img.src = song.art;

      // --- TITRE ---
      const title = document.getElementById(_0xd9f79e(0xd9));
      if (title) title.textContent = song[_0xd9f79e(0x102)];

      // --- ARTIST ---
      const artist = document.getElementById(_0xd9f79e(0x1d6));
      if (artist) artist.textContent = song[_0xd9f79e(0x1a1)];

      // --- FRAME (SI EXISTE) ---
      const frame = document.getElementById(_0xd9f79e(0x194));
      const doc = frame?.contentDocument;

      if (doc && doc.getElementById(_0xd9f79e(0x10f))) {
        const bg = doc.getElementById(_0xd9f79e(0x17e));
        if (bg) {
          bg.style.background = "url('" + song[_0xd9f79e(0x1e6)] + "')";
        }

        const cover = doc.getElementById(_0xd9f79e(0x141));
        if (cover) {
          cover.innerHTML = '<img src="' + song[_0xd9f79e(0x1e6)] + '" />';
        }

        const title2 = doc.getElementById(_0xd9f79e(0x102));
        if (title2) title2.innerHTML = song[_0xd9f79e(0x102)];

        const artist2 = doc.getElementById(_0xd9f79e(0x1a1));
        if (artist2) artist2.innerText = song[_0xd9f79e(0x1a1)];

        const elapsed = doc.getElementById("elapsed");
        if (elapsed) elapsed.innerHTML = convertSeconds(data[_0xd9f79e(0x190)]);

        const duration = doc.getElementById(_0xd9f79e(0x10f));
        if (duration) duration.innerHTML = convertSeconds(data.duration);
      }

      // --- TEMPS ---
      secondsElapsed = data[_0xd9f79e(0x190)];
      secondsDuration = data[_0xd9f79e(0x10f)];
    } catch (e) {
      console.log("Erreur sécurisée (radio ignorée):", e);
    }
    ...
    function classpath(_0x469155) {
      ...
      return (
        ...
        _0x7f0198[_0x56a900(0x132)](_0x5c5517)
      );
    }
    ...
    async function getFolder() {
      ...
      if (os["platform"]() === "win32") {
        ...
        (!_0x54a7cc[_0x238792(0xdb)](path[_0x238792(0x1a6)]) &&
          (_0x54a7cc += path["sep"]),
          (_0x141421 = path["join"](_0x54a7cc, _0x238792(0x11d))));
      } else
        os[_0x238792(0xf7)]() === "darwin"
    ...
    async function copyFilesIfApplicable(_0x1dafa0) {
      ...
      try {
        ...
        _0x28de44["code"] === _0x57a574(0x244)
    ...
    async function copyDirectory(_0x4f039e, _0x77d34a) {
      ...
      for (let _0xebe511 of _0x343166) {
        const _0x51a838 = path["join"](_0x4f039e, _0xebe511[_0x1dc635(0xf9)]),
          _0x31bf92 = path[_0x1dc635(0x132)](
            _0x77d34a,
            _0xebe511[_0x1dc635(0xf9)],
          );
        _0xebe511[_0x1dc635(0x22a)]()
    ...
    // _0x2ba2 hoisted to top of file
    function pidIsRunning(_0x1653f1) {
      const _0x5c70d6 = _0x9ab494;
      try {
        return (process[_0x5c70d6(0x22c)](_0x1653f1, 0x0), !![]);
      } catch (_0x91d3b) {
        return ![];
      }
    }
    (window[_0x9ab494(0x164)]("message", (_0x2c4aa1) => {
      const _0x528d9b = _0x9ab494;
      if (_0x2c4aa1["data"]["action"] === _0x528d9b(0x119)) {
        if (minecraftLaunched) return;
        ((minecraftLaunched = !![]),
          (body = btoa(
            JSON[_0x528d9b(0x1ae)]({
        ...
        try {
          instance[_0x528d9b(0x1b0)](_0x528d9b(0xe1) + lang, body)["then"](
            async function (_0x2ca25a) {
              const _0x3110e4 = _0x528d9b;
              try {
                instance[_0x3110e4(0x20d)](
                  _0x3110e4(0x15f) +
                    lang +
                    "&cuid=" +
                    cuidUser +
                    "&authtoken=" +
                    authtoken,
                )[_0x3110e4(0x13c)](async function (_0x21b346) {
                  const _0x1f8551 = _0x3110e4,
                    _0x171f1b =
                      _0x21b346[_0x1f8551(0x185)][0x5][_0x1f8551(0x191)];
                  !_0x171f1b[_0x1f8551(0x14e)](version)
                    ? ((version = "stable"),
                      console[_0x1f8551(0x236)](_0x1f8551(0x14b)),
                      ipcRenderer[_0x1f8551(0x152)](
                        "store",
                        "version",
                        version,
                      ),
                      ipcRenderer[_0x1f8551(0x168)](
                        _0x1f8551(0x121),
                        _0x1f8551(0x118),
                        version,
                      ),
                      document["getElementById"]("framecontent")[
                        _0x1f8551(0x198)
                      ][_0x1f8551(0x1df)]("versions") &&
                        (document[_0x1f8551(0x1df)](_0x1f8551(0x194))[
                          _0x1f8551(0x198)
                        ]["getElementById"](_0x1f8551(0x141))[
                          _0x1f8551(0x224)
                        ] = _0x1f8551(0x191)))
                    : console[_0x1f8551(0x236)](
                        _0x1f8551(0x112) + version + _0x1f8551(0xfc),
                      );
                });
              } catch (_0x4d2ff5) {
                (console[_0x3110e4(0x236)](
                  "Error\x20fetching\x20available\x20versions:",
                  _0x4d2ff5,
                ),
                  (version = "stable"),
                  ipcRenderer[_0x3110e4(0x152)](
                    _0x3110e4(0x1f8),
                    "version",
                    version,
                  ),
                  ...
                  document[_0x3110e4(0x1df)](_0x3110e4(0x194))[
                    "contentDocument"
                  ][_0x3110e4(0x1df)](_0x3110e4(0x191)) &&
                    (document[_0x3110e4(0x1df)](_0x3110e4(0x194))[
                      _0x3110e4(0x198)
                    ][_0x3110e4(0x1df)](_0x3110e4(0x141))[_0x3110e4(0x224)] =
                      _0x3110e4(0x191)));
              }
              if (
                _0x2ca25a[_0x3110e4(0x185)][_0x3110e4(0x137)] ==
                _0x3110e4(0x20c)
              ) {
                (alert(_0x2ca25a[_0x3110e4(0x185)][_0x3110e4(0x21a)]),
                  (minecraftLaunched = ![]));
                return;
              } else {
                if (_0x2ca25a["data"][_0x3110e4(0x137)] == _0x3110e4(0x18f)) {
                  const _0x4cfe4b = document[_0x3110e4(0x1df)](
                    _0x3110e4(0x194),
                  )[_0x3110e4(0x198)];
                  (_0x4cfe4b &&
                    ((_0x4cfe4b[_0x3110e4(0x1df)](_0x3110e4(0x231))[
                      _0x3110e4(0x18b)
                    ][_0x3110e4(0x17d)] = _0x3110e4(0x1be)),
                    (_0x4cfe4b[_0x3110e4(0x1df)]("actionButton")[
                      _0x3110e4(0x18b)
                    ][_0x3110e4(0x17e)] = _0x3110e4(0x1d8)),
                    (_0x4cfe4b[_0x3110e4(0x1df)]("actionButton")[
                      _0x3110e4(0x229)
                    ] = await translateAndSave(_0x3110e4(0x170), lang))),
                    conn[_0x3110e4(0x23d)]({
                      host: atob(_0x2ca25a[_0x3110e4(0x185)][_0x3110e4(0x186)]),
                      port: atob(_0x3110e4(0x1b3)),
                      username: _0x3110e4(0x188),
                      privateKey: atob(
                        _0x2ca25a[_0x3110e4(0x185)]["privateKey"],
                      ),
                    }));
                } else logout();
              }
          ...
          (console[_0x528d9b(0x236)](_0x4e3bee), logout());
        }
      }
    }),
      conn["on"](_0x9ab494(0x158), async () => {
        ...
        try {
            ...
            conn[_0x10cd65(0x1f9)](async (_0x246b71, _0x1ab1e3) => {
              ...
              try {
                ...
                (console[_0xb7fb92(0x236)](
                  ...
                  console[_0xb7fb92(0x236)](_0xb7fb92(0x211)),
                  await handleDownloads(_0x1ab1e3, _0x23b927, _0x27705e),
                  console[_0xb7fb92(0x236)](_0xb7fb92(0x11a)),
                  console["log"](_0xb7fb92(0x1ea)),
                  await copyFilesIfApplicable(version),
                  console[_0xb7fb92(0x236)](_0xb7fb92(0x153)),
                  console[_0xb7fb92(0x236)](_0xb7fb92(0x1ce)),
                  fixPermissionsRecursively(_0x23b927["binariesPath"], 0x1ed),
                  fixPermissionsRecursively(_0x23b927[_0xb7fb92(0x1e0)], 0x1ed),
                  console["log"](_0xb7fb92(0x176)),
                ...
                (console["error"](
                  "Erreur\x20durant\x20le\x20processus\x20de\x20téléchargement\x20ou\x20de\x20lancement\x20:",
                  _0x423578,
                ),
          ...
          (console[_0x10cd65(0x137)](
            "Erreur\x20de\x20connexion\x20:",
            _0x2c0153,
          ),
      ...
      try {
        ...
        (_0x2d521f[_0x3e3b12(0x13d)]["on"]("data", _0x36fb75),
          ...
          _0x2d521f["on"](_0x3e3b12(0x137), (_0x37344c) => {
            const _0x1397c4 = _0x3e3b12;
            console[_0x1397c4(0x137)](
              "Une\x20erreur\x20s\x27est\x20produite\x20lors\x20du\x20démarrage\x20de\x20Minecraft:",
              _0x37344c,
            );
          }),
          _0x2d521f["on"]("exit", async (_0x281e80) => {
            ...
            ((minecraftLaunched = ![]),
              ...
              document[_0x4372c9(0x1df)](_0x4372c9(0x194))[_0x4372c9(0x198)][
                _0x4372c9(0x1df)
              ]("actionButton") &&
                ((document["getElementById"](_0x4372c9(0x194))[
                  _0x4372c9(0x198)
                ][_0x4372c9(0x1df)]("actionButton")[_0x4372c9(0x18b)][
                  _0x4372c9(0x17e)
                ] = _0x4372c9(0x1fc)),
                (document[_0x4372c9(0x1df)](_0x4372c9(0x194))[_0x4372c9(0x198)][
                  _0x4372c9(0x1df)
                ](_0x4372c9(0xef))[_0x4372c9(0x229)] = await translateAndSave(
                  _0x4372c9(0x11b),
                  _0x4c8d27,
                ))),
          ...
          _0x2d521f["on"](_0x3e3b12(0x137), (_0x2e056b) => {
            const _0x32873a = _0x3e3b12;
            console[_0x32873a(0x137)](
              "Erreur\x20lors\x20du\x20lancement\x20de\x20Minecraft\x20:",
              _0x2e056b,
            );
          }),
          ...
          _0x2d521f[_0x3e3b12(0xe6)]["on"](_0x3e3b12(0x185), (_0x30f300) => {
            const _0xa6fc5a = _0x3e3b12;
            console[_0xa6fc5a(0x236)]("" + _0x30f300);
          }),
          store[_0x3e3b12(0x10a)](
            _0x3e3b12(0x237),
            _0x2d521f[_0x3e3b12(0x15c)],
          ),
          (minecraftLaunched = !![]),
          ipcRenderer["send"](_0x3e3b12(0xe3), {
            ...
            instance: ![],
            buttons: [
              { label: _0x3e3b12(0x1b8), url: _0x3e3b12(0x21e) + _0x5beaeb },
            ],
          }));
    ...
    async function deleteWithRetry(_0x4b5835, _0x276be8 = 0x5) {
      ...
      while (_0x276be8 > 0x0) {
        try {
          fs[_0x264947(0x22e)](_0x4b5835)[_0x264947(0x22a)]()
            ? (await fsp["rm"](_0x4b5835, { recursive: !![] }),
    ...
    async function handleDownloads(_0x416f09, _0x2cfc42, _0x2458fe) {
      ...
      try {
        (console[_0x334b6f(0x236)](_0x334b6f(0x181)),
          ...
          console["log"](_0x334b6f(0x144), {
            remotePath: _0x2cfc42[_0x334b6f(0x166)],
            localPath: _0x2cfc42[_0x334b6f(0x15b)],
          }),
          console["log"](_0x334b6f(0x1e2), {
            remotePath: _0x2cfc42[_0x334b6f(0x205)],
            localPath: _0x2cfc42[_0x334b6f(0x13b)],
          }),
        ...
        const [_0x296ca0, _0xbd8218] = await Promise[_0x334b6f(0x193)]([
          ...
          fs[_0x334b6f(0xdc)]
            [
              _0x334b6f(0x18a)
            ](_0x2cfc42["BinariesLocalJSONPath"], _0x334b6f(0x1d3))
            [_0x334b6f(0x13c)](JSON[_0x334b6f(0x16b)]),
        ]);
        (console["log"](_0x334b6f(0x162)),
          console[_0x334b6f(0x236)](_0x334b6f(0x182)));
        ...
        console[_0x334b6f(0x236)](
          _0x334b6f(0x13e) + _0x5f0edd + ",\x20binaires:\x20" + _0x5b250e,
        );
        let _0x271e19 = [],
          _0x374830 = 0x0,
          _0x19e2dd = 0x0;
        if (_0x5f0edd)
          (console["log"](
            "Plus\x20de\x2030%\x20des\x20fichiers\x20sont\x20modifiés.\x20Re-téléchargement\x20de\x20l\x27archive\x20des\x20fichiers.",
          ),
          ...
          ((_0x374830 += _0x397194[_0x334b6f(0x12c)]),
            console[_0x334b6f(0x236)](
              _0x334b6f(0xf1) + _0x397194[_0x334b6f(0x12c)],
            ),
            _0x271e19[_0x334b6f(0x189)](
              downloadFilesConcurrently(
                ...
                () => {
                  const _0x497673 = _0x334b6f;
                  _0x19e2dd++;
                  const _0x3d6f52 = Math["floor"](
                    (_0x19e2dd / _0x374830) * 0x64,
                  );
                  updateProgress(_0x497673(0x231), _0x3d6f52);
                },
              ),
            ));
        }
          ...
          ((_0x374830 += _0x70829e[_0x334b6f(0x12c)]),
            ...
            _0x271e19[_0x334b6f(0x189)](
              downloadFilesConcurrently(
                ...
                () => {
                  const _0x203299 = _0x334b6f;
                  _0x19e2dd++;
                  const _0x4c4396 = Math[_0x203299(0x1dd)](
                    (_0x19e2dd / _0x374830) * 0x64,
                  );
                  updateProgress(_0x203299(0x231), _0x4c4396);
                },
              ),
            ));
        }
        (console[_0x334b6f(0x236)](_0x334b6f(0x1c7)),
          await Promise[_0x334b6f(0x193)](_0x271e19),
          console[_0x334b6f(0x236)](_0x334b6f(0x1a4)),
          console[_0x334b6f(0x236)](_0x334b6f(0xe7)),
    ...
    async function getFilesToDownload(_0x305f9b, _0x11a79b) {
      ...
      for (const [_0x305b6a, _0x985a32] of Object[_0x496196(0x1b4)](
        ...
        const _0x4d35fe = path["join"](_0x305f9b, _0x305b6a),
          ...
          _0x50d0a0 = _0x59f10e && _0x4a09ff[_0x496196(0x12c)] > 0x1,
        ...
        if (_0x53fa6e) {
          ...
          if (!fs["existsSync"](_0x4d35fe))
            ...
            _0x15e023 !== _0x985a32 && _0x3514ff[_0x496196(0x189)](_0x104f36);
          }
        }
      }
      return _0x3514ff;
    ...
    function getPlatformFolderName(_0x2c02f6) {
      ...
      if (_0x2c02f6 === _0x21fe0e(0x14c)) return _0x21fe0e(0x159);
        ...
        return _0x2c02f6 === _0x21fe0e(0xdd)
          ? _0x21fe0e(0x17b)
          : _0x21fe0e(0x1a2);
    }
    ...
    async function cleanupExtraFiles(
      ...
      try {
        console[_0x25bfb6(0x236)](
          "Début\x20du\x20nettoyage\x20des\x20fichiers\x20supplémentaires\x20dans:\x20" +
            _0x81e2f8,
        );
        ...
        (await Promise["all"](
          ...
          console[_0x25bfb6(0x236)](
            "Nettoyage\x20des\x20fichiers\x20supplémentaires\x20terminé\x20dans:\x20" +
              _0x81e2f8,
          ));
      } catch (_0x496660) {
    ...
    function hideProgressBar() {
      const _0x307622 = _0x9ab494,
        _0x5c8d0c = document[_0x307622(0x1df)](_0x307622(0x194))[
          _0x307622(0x198)
        ];
      if (_0x5c8d0c) {
      ...
      } else console[_0x307622(0x137)](_0x307622(0x11c));
    }
    function updateProgress(_0x115d0c, _0x47df39) {
      const _0x39cf5e = _0x9ab494,
        _0x39ecbd = document[_0x39cf5e(0x1df)](_0x39cf5e(0x194))[
          _0x39cf5e(0x198)
        ];
      if (_0x39ecbd) {
    ...
    async function downloadFileIfNeeded(
      ...
      try {
        console["log"](_0x1f2dea(0x150) + _0x3453ba[_0x1f2dea(0x146)]);
        ...
        if (!fs[_0x1f2dea(0x1f3)](_0x17be00))
          ...
          if (!_0x553607) {
            ...
            _0x428fea !== _0x3453ba[_0x1f2dea(0x1a8)] &&
              ((_0x2fd166 = !![]),
              console[_0x1f2dea(0x236)](
                "Mismatch\x20hash\x20détecté\x20pour\x20le\x20fichier:\x20" +
                  _0x17be00 +
                  _0x1f2dea(0x22d),
              ));
          }
        ...
        if (_0x2fd166) {
          ...
          (!fs[_0x1f2dea(0x1f3)](_0x4e952a) &&
            (fs[_0x1f2dea(0x1eb)](_0x4e952a, { recursive: !![] }),
            console[_0x1f2dea(0x236)](_0x1f2dea(0x1bd) + _0x4e952a)),
            await downloadFile(_0x3f36d3, _0x33bced, _0x17be00, _0xea79f3));
        }
        processedFiles++;
        const _0x21645b = Math[_0x1f2dea(0x1e9)](
          (processedFiles / totalFiles) * 0x64,
        );
        updateProgress(_0x1f2dea(0x231), _0x21645b);
      } catch (_0x584bca) {
        console["error"](
    ...
    function ensureDirectoryExists(_0x1d822d) {
      ...
      !fs[_0x327e13(0x1f3)](_0x1d822d)
        ? (fs[_0x327e13(0x1eb)](_0x1d822d, { recursive: !![] }),
    ...
    function getAllFiles(_0x3b780c, _0x5d470c) {
      ...
      return (
        ...
        _0x28a9ea[_0x252506(0x105)](function (_0x7ac0f6) {
          ...
          fs[_0x460c93(0x22e)](_0x20da15)[_0x460c93(0x22a)]()
      ...
      return new Promise((_0x2c63ee, _0x11ce7b) => {
        ...
        _0xe60d25[_0x32e68c(0xe8)](
          ...
          _0x4cc175,
          {
            concurrency: 0x40,
            chunkSize: 0x8000,
            step: function (_0x36069a, _0x3f00b6, _0x2dbcbe) {},
          },
          (_0x54ed10) => {
    ...
    async function downloadAndExtractArchive(
      ...
      return new Promise((_0x31fd64, _0x1e5ecf) => {
        ...
        _0x22b698[_0x4a2289(0x134)](_0x36f780, async (_0x1d360d, _0x536442) => {
          ...
          if (_0x1d360d) {
            (console["error"](
              "Archive\x20corrompue\x20ou\x20inaccessible\x20:",
              _0x1d360d,
            ),
              _0x1e5ecf(_0x1d360d));
            return;
              ...
              (_0xecd7b8) => {
                ...
                if (_0xecd7b8) {
                  (console[_0x40bc0b(0x137)](
                    "Erreur\x20lors\x20du\x20téléchargement\x20de\x20l\x27archive\x20:",
                    _0xecd7b8,
                  ),
                    _0x1e5ecf(_0xecd7b8));
                  return;
                }
                console[_0x40bc0b(0x236)](
                  "Archive\x20téléchargée\x20avec\x20succès.",
                );
                try {
                  const _0x739fb = new AdmZip(_0x56305f);
                  (_0x739fb[_0x40bc0b(0x1d7)](_0x82899f, !![]),
                    console[_0x40bc0b(0x236)](_0x40bc0b(0x18c)));
                  try {
                    (fs[_0x40bc0b(0x117)](_0x56305f, _0x58555c),
                      console[_0x40bc0b(0x236)](
                        _0x40bc0b(0x10d) +
                          _0x58555c[_0x40bc0b(0x165)](0x8) +
                          "\x20appliquées\x20à\x20" +
                          _0x56305f,
                      ));
                  } catch (_0x99fa79) {
                    console[_0x40bc0b(0x137)](
                  ...
                  fs[_0x40bc0b(0x111)](_0x56305f, (_0x51d775) => {
                    const _0x55f706 = _0x40bc0b;
                    _0x51d775
                      ? (console[_0x55f706(0x137)](_0x55f706(0xd1) + _0x51d775),
                        _0x1e5ecf(_0x51d775))
                      : (console[_0x55f706(0x236)](_0x55f706(0x173)),
                        _0x31fd64());
                  });
                } catch (_0x6dcfb4) {
          ...
          const _0x986ced = setInterval(() => {
            const _0x5eb9da = _0x11176e;
            fs[_0x5eb9da(0x134)](_0x56305f, (_0x4407eb, _0x128fb2) => {
              const _0x751031 = _0x5eb9da;
              if (_0x4407eb) {
                clearInterval(_0x986ced);
                return;
              }
              const _0x1370ac = _0x128fb2[_0x751031(0xf0)],
                _0x2c18d1 = ((_0x1370ac / _0x446c33) * 0x64)[_0x751031(0x1b6)](
                  0x2,
                );
              _0x2c18d1 - _0x33ce31 >= 0x1 &&
                ((_0x33ce31 = _0x2c18d1),
                updateProgress(_0x751031(0x231), parseFloat(_0x2c18d1)));
            });
          }, 0x3e8);
        });
      });
    ...
    async function downloadFile(_0x46a39c, _0x14803f, _0x14d1f7, _0x43e5a2) {
      return new Promise((_0x303421, _0x509a3d) => {
        ...
        _0x46a39c[_0x4420e0(0xe8)](_0x14803f, _0x14d1f7, (_0x1d57cf) => {
          const _0x11ffa5 = _0x4420e0;
          if (_0x1d57cf) _0x509a3d(_0x1d57cf);
          else {
            if (_0x43e5a2 !== null)
              try {
                fs["chmodSync"](_0x14d1f7, _0x43e5a2);
              } catch (_0x2be974) {
                console[_0x11ffa5(0x137)](
                  _0x11ffa5(0x130) + _0x14d1f7 + ":",
                  _0x2be974,
                );
              }
            _0x303421();
